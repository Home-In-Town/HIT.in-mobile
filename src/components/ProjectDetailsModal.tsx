...
const m = StyleSheet.create({
  ...
  pad: { padding: 18 },
  name: { fontSize: 21, fontWeight: '800', color: colors.ink, letterSpacing: -0.5 },
  locRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 5 },
  loc: { fontSize: 12, color: colors.muted2, fontWeight: '600' },
  ...
  priceLabel: { fontSize: 9, fontWeight: '800', color: colors.muted, letterSpacing: 0.5, textTransform: 'uppercase' },
  priceValue: { fontSize: 21, fontWeight: '800', color: colors.ink, letterSpacing: -0.5 },
  priceValueSmall: { fontSize: 14, fontWeight: '800', color: colors.ink },
  pricePerSqft: { marginLeft: 'auto', alignItems: 'flex-end' },
  sectionTitle: { fontSize: 14, fontWeight: '800', color: colors.ink, marginTop: 22, marginBottom: 12 },
  ...
  detailLabel: { fontSize: 9, fontWeight: '800', color: colors.muted, letterSpacing: 0.5, textTransform: 'uppercase' },
  detailValue: { fontSize: 12.5, fontWeight: '700', color: colors.ink },
  ...
  amenityText: { fontSize: 11, fontWeight: '700', color: colors.brand },
  ...
  ownerInitial: { color: '#fff', fontSize: 17, fontWeight: '800' },
  ownerName: { fontSize: 14, fontWeight: '800', color: colors.ink },
  ownerRole: { fontSize: 11, color: colors.muted2, fontWeight: '600', marginTop: 1, textTransform: 'capitalize' },
});
