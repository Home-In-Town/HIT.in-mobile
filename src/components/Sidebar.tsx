...
const st = StyleSheet.create({
  ...
  logoLetter: { color: '#fff', fontWeight: '800', fontSize: 19 },
  brandName: { fontSize: 15, fontWeight: '800', color: colors.ink },
  brandSub: { fontSize: 9, color: colors.brand, fontWeight: '700', letterSpacing: 1, textTransform: 'uppercase' },
  ...
  userRole: { fontSize: 11, color: colors.brand, fontWeight: '600', marginTop: 1 },
  sectionLabel: { fontSize: 9, fontWeight: '800', color: colors.muted, letterSpacing: 1, paddingHorizontal: 20, paddingTop: 10, paddingBottom: 6 },
  navItem: {
  ...
  navLabel: { flex: 1, fontSize: 14, fontWeight: '600', color: colors.muted2 },
  ...
  settingsText: { fontSize: 14, fontWeight: '600', color: colors.muted2 },
  signOut: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    paddingHorizontal: 20, paddingVertical: 12,
  },
