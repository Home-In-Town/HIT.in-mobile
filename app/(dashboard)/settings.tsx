...
const s = StyleSheet.create({
  ...
  profileRole: { fontSize: 12.5, color: colors.brand, fontWeight: '700', marginTop: 1 },
  section: { gap: 8 },
  sectionLabel: { fontSize: 10.5, fontWeight: '800', color: colors.muted, letterSpacing: 1, paddingLeft: 4 },
  ...
  rowSub: { fontSize: 11.5, color: colors.muted2, marginTop: 1 },
  ...
  signOutText: { fontSize: 14.5, fontWeight: '800', color: colors.red },
});
