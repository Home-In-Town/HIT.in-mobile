...
const s = StyleSheet.create({
  ...
  cardDesc: { fontSize: 12, color: colors.muted2, marginTop: 2 },
  deleteBtn: { padding: 6 },
  metaRow: { flexDirection: 'row', gap: 14 },
  metaText: { fontSize: 12, color: colors.muted2, fontWeight: '600' },
  detail: { borderTopWidth: 1, borderTopColor: colors.line, paddingTop: 10, gap: 10 },
  detailLabel: { fontSize: 12, fontWeight: '700', color: colors.muted2, textTransform: 'uppercase', marginBottom: 4 },
  detailItem: { fontSize: 13, color: colors.ink, paddingVertical: 2 },
  ...
  agentChipText: { fontSize: 12, fontWeight: '600', color: colors.brand },
