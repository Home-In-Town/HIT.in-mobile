            ...
            <ScrollView contentContainerStyle={{ padding: 16, gap: 14 }}>
              {[{ label: 'Room Name *', key: 'name', placeholder: 'e.g. Pune Builders' },
                ...
                <View key={f.key} style={{ gap: 5 }}>
                  <Text style={{ fontSize: 12, fontWeight: '600', color: colors.ink }}>{f.label}</Text>
                  <TextInput
...
const s = StyleSheet.create({
  ...
  threadSub: { fontSize: 11, color: colors.muted },
...
const rl = StyleSheet.create({
  ...
  members: { fontSize: 11, color: colors.muted2, marginTop: 2 },
...
const mb = StyleSheet.create({
  system: { textAlign: 'center', fontSize: 11, color: colors.muted, fontStyle: 'italic', marginVertical: 4 },
  ...
  senderName: { fontSize: 10, fontWeight: '700', color: colors.brand, marginBottom: 2 },
  ...
  cardLine: { fontSize: 11, color: colors.muted2 },
  cardFooter: { fontSize: 10, color: colors.muted, marginTop: 2 },
});
