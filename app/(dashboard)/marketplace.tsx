          ...
          <View style={{ gap: 6 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
              <View style={[ds.typeBadge, { backgroundColor: listing.listingType === 'selling' ? colors.greenBg : colors.blueBg }]}>
                <Text style={{ fontSize: 10, fontWeight: '800', color: listing.listingType === 'selling' ? colors.greenText : colors.blueText }}>
                  {listing.listingType.toUpperCase()}
                </Text>
              </View>
              <View style={[ds.statusBadge, { backgroundColor: sc.bg }]}>
                <Text style={{ fontSize: 10, fontWeight: '700', color: sc.text }}>{listing.status}</Text>
              </View>
            </View>
...
const ds = StyleSheet.create({
  ...
  projectName: { fontSize: 22, fontWeight: '800', color: colors.ink },
  city: { fontSize: 13, color: colors.muted2 },
  ...
  chipText: { fontSize: 12, fontWeight: '600', color: colors.slateText },
  ...
  priceLabel: { fontSize: 11, color: colors.muted, fontWeight: '600' },
  priceVal: { fontSize: 20, fontWeight: '800', color: colors.ink, marginTop: 2 },
  commBox: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  commLabel: { fontSize: 11, color: colors.muted, fontWeight: '600' },
  commVal: { fontSize: 16, fontWeight: '800', color: colors.brand, marginTop: 2 },
  descCard: { backgroundColor: colors.white, borderRadius: 14, borderWidth: 1, borderColor: colors.line, padding: 14, gap: 6 },
  descLabel: { fontSize: 12, fontWeight: '700', color: colors.muted2 },
  descText: { fontSize: 14, color: colors.ink, lineHeight: 20 },
  ...
  listedByAvatarText: { color: '#fff', fontWeight: '800', fontSize: 16 },
  listedByName: { fontSize: 14, fontWeight: '700', color: colors.ink },
  listedByRole: { fontSize: 12, color: colors.muted2 },
});
...
const cm = StyleSheet.create({
  ...
  toggleText: { fontSize: 13, fontWeight: '600', color: colors.muted2 },
  ...
  projChipText: { fontSize: 12, fontWeight: '600', color: colors.muted2 },
  input: { borderWidth: 1, borderColor: colors.line, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontSize: 14, color: colors.ink, backgroundColor: colors.white },
...
const mc = StyleSheet.create({
  ...
  badgeText: { fontSize: 7.5, fontWeight: '800', color: '#fff', letterSpacing: 0.5 },
  ...
  loc: { fontSize: 11.5, color: colors.muted2, fontWeight: '500', flex: 1 },
  ...
  price: { fontSize: 16, fontWeight: '800', color: colors.brand, letterSpacing: -0.3 },
  perSqft: { fontSize: 10, color: colors.muted, fontWeight: '700' },
  matchRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  matchDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#3F6212' },
  matchText: { fontSize: 10.5, fontWeight: '800', color: '#3F6212' },
  ...
  chipText: { fontSize: 8.5, fontWeight: '800' },
  ...
  viewText: { color: '#fff', fontSize: 11.5, fontWeight: '800' },
  ...
  shareText: { color: colors.brand, fontSize: 11.5, fontWeight: '800' },
});
...
const rr = StyleSheet.create({
  ...
  desc: { fontSize: 11.5, color: colors.muted2, marginTop: 2 },
  by: { fontSize: 10.5, color: colors.muted, marginTop: 2, fontWeight: '600' },
  ...
  commText: { fontSize: 10, fontWeight: '800', color: '#fff' },
});
...
const m = StyleSheet.create({
  ...
  subtitle: { fontSize: 10.5, color: colors.muted, fontWeight: '600', marginTop: 1 },
  ...
  segText: { fontSize: 11, fontWeight: '800', color: colors.muted, letterSpacing: 1 },
  segTextActive: { color: colors.brand },
  discover: { fontSize: 11.5, color: colors.muted2, fontWeight: '500', marginBottom: 4 },
  ...
  filterLabel: { fontSize: 11, fontWeight: '700', color: colors.muted2 },
  filterInput: { borderWidth: 1, borderColor: colors.line, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8, fontSize: 13, color: colors.ink, backgroundColor: colors.cream },
  clearBtn: { alignSelf: 'flex-start', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, backgroundColor: colors.slateBg },
  clearBtnText: { fontSize: 12, fontWeight: '600', color: colors.slateText },
  // Cards (2-column grid)
  ...
  cityText: { fontSize: 11, color: colors.muted2 },
  ...
  bhkText: { fontSize: 10, fontWeight: '600', color: colors.slateText },
  price: { fontSize: 13, fontWeight: '800', color: colors.brand },
  commRow: { flexDirection: 'row', alignItems: 'center', gap: 4, flexWrap: 'wrap' },
  commText: { fontSize: 11, fontWeight: '700', color: colors.brand, flex: 1 },
