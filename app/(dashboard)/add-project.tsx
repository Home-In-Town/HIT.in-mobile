...
const s = StyleSheet.create({
  ...
  sectionNumText: { fontSize: 10, fontWeight: '800', color: colors.muted2 },

  field: { marginBottom: 14 },
  label: { fontSize: 11.5, fontWeight: '700', color: colors.muted2, marginBottom: 7 },
  input: { borderWidth: 1, borderColor: colors.line, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, fontSize: 13, color: colors.ink, backgroundColor: colors.white },
  hint: { fontSize: 11, color: colors.brand, fontWeight: '700', marginTop: -6, marginBottom: 12 },
  row2: { flexDirection: 'row', gap: 12 },
  subHeading: { fontSize: 11, fontWeight: '800', color: colors.muted2, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 10, marginTop: 2 },

  toggleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 },
  toggleLabel: { fontSize: 12.5, fontWeight: '700', color: colors.ink },
  ...
  chipText: { fontSize: 11.5, fontWeight: '700', color: colors.muted2 },
  chipTextOn: { color: '#fff' },
  seeMore: { marginTop: 8 },
  seeMoreText: { fontSize: 11.5, fontWeight: '800', color: colors.brand },
  ...
  uploadBoxText: { fontSize: 12, fontWeight: '700', color: colors.ink },
  uploadBoxSub: { fontSize: 10, color: colors.muted },
  ...
  coverOverlayText: { color: '#fff', fontSize: 11, fontWeight: '700' },
  ...
  smallUploadText: { fontSize: 11.5, fontWeight: '800', color: colors.brand },
  ...
  fileChipText: { flex: 1, fontSize: 11.5, fontWeight: '600', color: colors.ink },

  progress: { fontSize: 12, fontWeight: '700', color: colors.brand, textAlign: 'center', marginBottom: 10 },
  ...
  draftText: { color: colors.brand, fontSize: 13.5, fontWeight: '800' },
