...
const s = StyleSheet.create({
  ...
  section: { gap: 10 },
  sectionLabel: { fontSize: 11, fontWeight: '700', color: colors.muted2, textTransform: 'uppercase', marginBottom: 4 },
  ...
  cardAvatarText: { color: '#fff', fontWeight: 'bold', fontSize: 15 },
  ...
  searchInput: { flex: 1, borderWidth: 1, borderColor: colors.line, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 11, fontSize: 13, color: colors.ink, backgroundColor: colors.white },
