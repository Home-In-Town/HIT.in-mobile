...
const s = StyleSheet.create({
  ...
  heroTopLabel: { fontSize: 12, fontWeight: '700', color: 'rgba(255,255,255,0.4)', letterSpacing: 1, textTransform: 'uppercase' },
  ...
  signOutText: { fontSize: 12, fontWeight: '700', color: '#fff' },
  ...
  heroName: { fontSize: 19, fontWeight: '800', color: '#fff', marginBottom: 5 },
  ...
  heroPhone: { fontSize: 12, color: 'rgba(255,255,255,0.4)', marginTop: 4 },
  ...
  heroStatLabel: { fontSize: 9, color: 'rgba(255,255,255,0.4)', fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.4 },
  ...
  sectionLabel: { fontSize: 11, fontWeight: '800', color: colors.muted2, textTransform: 'uppercase', letterSpacing: 0.8 },
  fieldWrap: { gap: 5 },
  fieldLabel: { fontSize: 13, fontWeight: '600', color: colors.ink },
  input: { borderWidth: 1, borderColor: colors.line, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontSize: 14, color: colors.ink, backgroundColor: colors.cream },
  ...
  detailValue: { fontSize: 13, fontWeight: '700', color: colors.ink, maxWidth: '60%' },
});
